...
export default function Footer() {
  ...
  return (
    <footer className="bg-velta-navy text-white">
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        {/* Основная часть футера - улучшенная адаптивность */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
          {/* О компании - занимает всю ширину на мобильных */}
          <div className="col-span-1 sm:col-span-2 lg:col-span-1 text-center sm:text-left">
            <div className="mb-4 sm:mb-6 flex justify-center sm:justify-start">
              <Logo 
                size="md" 
                className="filter brightness-0 invert w-auto h-16 sm:h-20 lg:h-24"
              />
            </div>
            <p className="text-gray-300 text-sm sm:text-base leading-relaxed mb-6 max-w-md mx-auto sm:mx-0">
              {t('description')}
            </p>
            {/* Социальные сети - центрированы на мобильных */}
            <div className="flex justify-center sm:justify-start space-x-3 sm:space-x-4">
              <a 
                href="https://t.me/velta_logistics_bot" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="w-10 h-10 sm:w-12 sm:h-12 bg-velta-royal-blue hover:bg-velta-navy transition-all duration-200 rounded-lg flex items-center justify-center hover:scale-105 active:scale-95 touch-manipulation"
                aria-label="Telegram"
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer" 
                className="w-10 h-10 sm:w-12 sm:h-12 bg-green-600 hover:bg-green-700 transition-all duration-200 rounded-lg flex items-center justify-center hover:scale-105 active:scale-95 touch-manipulation"
                aria-label="WhatsApp"
              >
                <svg className="w-5 h-5 sm:w-6 sm:h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2 sm:space-y-3">
              <li>
                <Link href="services/land" className="text-gray-300 hover:text-white transition-colors duration-200 text-sm sm:text-base">
                  {t('autoTransport')}
                </Link>
              </li>
              <li>
                <Link href="services/rail" className="text-gray-300 hover:text-white transition-colors duration-200 text-sm sm:text-base">
                  {t('railwayTransport')}
                </Link>
              </li>
              <li>
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              <div className="space-y-2 sm:space-y-3">
                <div className="flex items-start space-x-2 sm:space-x-3">
                  <svg className="w-4 h-4 sm:w-5 sm:h-5 text-white mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-start space-x-2 sm:space-x-3 pt-2 border-t border-gray-700">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="space-y-1">
                    ...
                    <a href="mailto:velta@velta.com.kz" className="text-white hover:text-velta-royal-blue transition-colors duration-200 text-sm break-all block">
                      velta@velta.com.kz
                    </a>
                  </div>
                </div>
