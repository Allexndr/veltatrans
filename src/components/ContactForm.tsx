...
export default function ContactForm() {
  ...
  const onSubmit = async (data: ContactFormData) => {
    ...
    try {
      // Here you would integrate with Bitrix24 or your CRM
          ...
          <div>
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                <div className="w-10 h-10 bg-velta-royal-blue rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  ...
                  <div className="space-y-1">
                    <p className="text-gray-600">{t('contact.phones.main')}</p>
                    <p className="text-gray-600">{t('contact.phones.office1')}</p>
                    <p className="text-gray-600">{t('contact.phones.office2')} <span className="text-sm text-gray-500">({t('contact.phones.multichannel')})</span></p>
                  </div>
                </div>
              </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  type="text"
                  id="name"
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-velta-royal-blue focus:border-transparent"
