            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              {services.map((service, index) => (
                <div key={index} className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow">
                  <div className="w-20 h-20 bg-custom-blue-600 rounded-lg flex items-center justify-center mb-6 text-white">
                    {service.icon}
                  </div>
                  ...
                  <ul className="space-y-2">
                    {service.features.map((feature, featureIndex) => (
                      <li key={featureIndex} className="flex items-center text-gray-700">
                        <svg className="w-5 h-5 text-custom-blue-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">
                Наши преимущества в сфере международной логистики
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600">Более 10 лет в сфере международной логистики</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">Работаем по всему миру</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">Гарантируем сохранность и своевременность</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">24/7 сопровождение ваших грузов</p>
              </div>
            </div>
          </div>
        </section>
