...
import { getCaseById, categories } from '@/data/cases';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              {caseItem.videos && caseItem.videos.length > 0 && (
                <div className="mb-8">
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">Видео материалы</h3>
              ...
              <div className="bg-white rounded-xl p-8 shadow-lg">
                <h3 className="text-2xl font-bold text-gray-900 mb-6">Описание проекта</h3>
                <div className="prose prose-lg max-w-none">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                    <div className="bg-gray-50 rounded-lg p-6">
                      <h4 className="font-semibold text-gray-900 mb-3">Маршрут</h4>
                    ...
                    <div className="bg-gray-50 rounded-lg p-6">
                      <h4 className="font-semibold text-gray-900 mb-3">Тип груза</h4>
                      <div className="flex items-center text-gray-700">
                        <svg className="w-5 h-5 mr-3 text-velta-navy" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="lg:col-span-1">
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg sticky top-6">
                <h3 className="text-xl font-bold text-gray-900 mb-6">Детали проекта</h3>
                ...
                <div className="mt-8 space-y-3">
                  ...
                  >
                    ← Назад к {getCategoryName(category)}
                  </Link>
