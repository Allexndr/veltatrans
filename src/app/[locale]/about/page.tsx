          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-4">{t('services.deadlineGuarantee.title')}</h3>
                <p className="text-gray-600">{t('services.deadlineGuarantee.description')}</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-4">{t('services.specialEquipment.title')}</h3>
                <p className="text-gray-600">{t('services.specialEquipment.description')}</p>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-4">{t('warehouse.title')}</h3>
                <p className="text-gray-600 mb-4">{t('warehouse.description')}</p>
                <div className="text-velta-navy font-semibold">{t('warehouse.specialists')}</div>
              </div>
            </div>
          </div>
        </section>
