            ...
            <div className="space-y-12">
              <div className="flex flex-col md:flex-row items-center">
                <div className="md:w-1/3 mb-6 md:mb-0">
                  <div className="text-6xl font-bold text-velta-navy">2014</div>
                </div>
                <div className="md:w-2/3 md:pl-8">
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">{t('history.2014.title')}</h3>
                  <p className="text-gray-600">{t('history.2014.description')}</p>
                </div>
              </div>
              
              <div className="flex flex-col md:flex-row items-center">
                <div className="md:w-1/3 mb-6 md:mb-0">
                  <div className="text-6xl font-bold text-velta-navy">2016</div>
                </div>
                <div className="md:w-2/3 md:pl-8">
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">{t('history.2016.title')}</h3>
                  <p className="text-gray-600">{t('history.2016.description')}</p>
                </div>
              </div>
              
              <div className="flex flex-col md:flex-row items-center">
                <div className="md:w-1/3 mb-6 md:mb-0">
                  <div className="text-6xl font-bold text-velta-navy">2018</div>
                </div>
                <div className="md:w-2/3 md:pl-8">
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">{t('history.2018.title')}</h3>
                  <p className="text-gray-600">{t('history.2018.description')}</p>
                </div>
              </div>
              
              <div className="flex flex-col md:flex-row items-center">
                <div className="md:w-1/3 mb-6 md:mb-0">
                  <div className="text-6xl font-bold text-velta-navy">2020</div>
                </div>
                <div className="md:w-2/3 md:pl-8">
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">{t('history.2020.title')}</h3>
                  <p className="text-gray-600">{t('history.2020.description')}</p>
                </div>
              </div>
              
              <div className="flex flex-col md:flex-row items-center">
                <div className="md:w-1/3 mb-6 md:mb-0">
                  <div className="text-6xl font-bold text-velta-navy">2022</div>
                </div>
                <div className="md:w-2/3 md:pl-8">
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">{t('history.2022.title')}</h3>
                  <p className="text-gray-600">{t('history.2022.description')}</p>
                </div>
              </div>
              
              <div className="flex flex-col md:flex-row items-center">
                <div className="md:w-1/3 mb-6 md:mb-0">
                  <div className="text-6xl font-bold text-velta-navy">2024</div>
                </div>
                <div className="md:w-2/3 md:pl-8">
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">{t('history.2024.title')}</h3>
                  <p className="text-gray-600">{t('history.2024.description')}</p>
                </div>
              </div>
            </div>
          </div>
